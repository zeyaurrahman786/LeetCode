    ...
    public List<List<String>> accountsMerge(List<List<String>> accounts) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 1; j < details.size(); j++) {
                ...
                // if we have already seen this email before, merge the account "i" with
                // previous account
                // else add it to hash
        ...
        // prepare a hash with index in accounts as key and list of unique email address
        // for that account as value
        ...
        // collect the emails from idToEmails, sort it and add account name at index 0
        // to get the final list to add to final return List
